...
def main() -> int:
    ...
    parser.add_argument(
        "--system-file", default=None, help="Path to file containing the system prompt"
    )
    parser.add_argument("--user", default=None, help="User prompt")
    parser.add_argument(
        "--user-file", default=None, help="Path to file containing the user prompt"
    )
    parser.add_argument(
        "--api", default="http://localhost:11434", help="Ollama API URL"
    )
